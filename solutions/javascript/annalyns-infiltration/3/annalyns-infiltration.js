...
export function canSpy(knightIsAwake, archerIsAwake, prisonerIsAwake) {
  ...
  //GOAL: when only the prisoner is awake
  //OUTPUT: 
  // knightIsAwake = false; //false
  // archerIsAwake = false; //true
...
export function canFreePrisoner(
  ...
  // else if could be used here, but because we are immediately returning in the previous if statement, another   if can be used.
